...
const minesweeper = (function () {
  ...
  class Game {
    ...
    addNeigborMine(x, y) {
      ...
      const item = this.neigborDetails.find(
  ...
  function start(config) {
    ...
    setInterval(self.game.render.bind(self.game), 100);
    setInterval(self.game.tick.bind(self.game), 300);
  }
